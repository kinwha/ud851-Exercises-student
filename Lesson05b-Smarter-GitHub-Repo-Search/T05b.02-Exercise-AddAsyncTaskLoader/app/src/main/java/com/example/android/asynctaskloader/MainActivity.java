...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int GITHUB_SEARCH_LOARDER = 22;
    ...
    private void makeGithubSearchQuery() {
        ...
        Loader<String> githubSearchLoarder = loaderManager.getLoader(GITHUB_SEARCH_LOARDER);
        if (githubSearchLoarder != null) {
            loaderManager.initLoader(GITHUB_SEARCH_LOARDER, queryBundle, this);
        } else {
            loaderManager.restartLoader(GITHUB_SEARCH_LOARDER, queryBundle, this);
        }
