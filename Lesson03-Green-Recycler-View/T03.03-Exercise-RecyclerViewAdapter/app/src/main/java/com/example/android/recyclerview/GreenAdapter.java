...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public GreenAdapter(int mNuberOfItems) {
        mNuberItems = mNuberOfItems;
    }
    ...
    // TODO (8) Within onBindViewHolder, call holder.bind and pass in the position0
    @Override
