...
public class SettingsFragment extends PreferenceFragmentCompat implements OnSharedPreferenceChangeListener{
    ...
    private void setPreferenceSummary(Preference prefrence,String value){
        if(prefrence instanceof ListPreference){
            ListPreference listPreference=(ListPreference)prefrence;
