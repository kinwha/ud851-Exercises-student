...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,/*드래그를 의미*/
    ...
    private boolean removeGuest(long id) {
        ...
        return (mDb.delete(WaitlistContract.WaitlistEntry.TABLE_NAME, WaitlistContract.WaitlistEntry._ID + "=" + id, null)) > 0; //delete는 제거된 행의개수 리턴
    }
}