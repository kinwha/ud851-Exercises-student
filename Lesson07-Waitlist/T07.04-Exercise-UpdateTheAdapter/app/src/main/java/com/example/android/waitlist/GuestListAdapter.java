...
public class GuestListAdapter extends RecyclerView.Adapter<GuestListAdapter.GuestViewHolder> {
    ...
    public void onBindViewHolder(GuestViewHolder holder, int position) {
        ...
        String name=mCurosr.getString(mCurosr.getColumnIndex(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME));
        // TODO (7) Call getInt on the cursor to get the party size
        int partySize=mCurosr.getInt(mCurosr.getColumnIndex(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE));
