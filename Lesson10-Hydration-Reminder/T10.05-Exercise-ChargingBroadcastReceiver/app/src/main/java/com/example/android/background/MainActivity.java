...
public class MainActivity extends AppCompatActivity implements
    ...
    ChargningBroadcastReceiver mChargingReceiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChargingReceiver = new ChargningBroadcastReceiver();
    ...
    public class ChargningBroadcastReceiver extends BroadcastReceiver {
        @Override
        public void onReceive(Context context, Intent intent) {
            String action = intent.getAction();
            boolean isChargning = (action.equals(Intent.ACTION_POWER_CONNECTED));
            showCharging(isChargning);
        }
