...
public class NotificationUtils {
    ...
    static Action drinkWaterAction(Context context) {
        ...
        in.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        //      TODO (14) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent pi = PendingIntent.getService(context, ACTION_DRINK_PENDING_INTENT_ID, in, PendingIntent.FLAG_CANCEL_CURRENT);
        //      TODO (15) Create an Action for the user to tell us they've had a glass of water
        Action drinkAction = new Action(R.drawable.ic_local_drink_black_24px, "drink", pi);
