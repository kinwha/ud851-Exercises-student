...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBKACS_TEXT_KEY="call back";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            String saveData=savedInstanceState.getString(LIFECYCLE_CALLBKACS_TEXT_KEY);
            mLifecycleDisplay.setText(saveData);
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String savaData=mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBKACS_TEXT_KEY,savaData);
    }
